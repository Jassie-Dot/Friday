...
// Simplex 3D noise for organic plasma movement
...
void main() {
  ...
  // Multi-layered plasma displacement
  ...
  vPlasmaIntensity = abs(displacement) / displacementAmount;
