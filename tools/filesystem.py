...
class FileSystemTool(BaseTool):
    name = "filesystem"
    description = "Reads, writes, appends, lists, and creates files inside approved roots."
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        ...
        if action == "read":
            ...
            return ToolResult(success=True, output=path.read_text(encoding="utf-8"), metadata={"path": str(path)})
